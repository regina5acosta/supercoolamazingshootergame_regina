...
PAUSE_SWIG_EXCEPTIONS
	...
	%flatnested AkArray<AK::SoundEngine::DynamicSequence::PlaylistItem, AK::SoundEngine::DynamicSequence::PlaylistItem const &,ArrayPoolDefault,AkGrowByPolicy_Proportional>::Iterator;
